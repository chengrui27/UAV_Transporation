...
: ${AMENT_CURRENT_PREFIX:="/home/chen/px4_ws/install/plan_env"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/plan_env/environment/pythonpath.sh"
